...
func NewPokemonsConcurrency() pokemonsConcurrency {
	return pokemonsConcurrency{}
}

func (pokemonsConcurrency) GetPokemonsConcurrency(t string, items int, ipw int) ([]*entities.Pokemon, error) {
